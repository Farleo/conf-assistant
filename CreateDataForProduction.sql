...
('5G in 2020', '5G20', '2020-04-27', '2020-04-28', 'The 2020 edition of The European 5G Conference will take place in Brussels, Belgium on 29 & 30 January. Now in its 4th year, the European 5G Conference has an established reputation as Brussels’ leading meeting place for discussion on 5G policy.
...
(33, 'Richard', 'Hendricks', '$2a$10$jbI6s.FAIGRzurrzf9p4Ief/QfWAhzrcMIh.VHbwN111ykpI1O1T.', 'richard@gmail.com', 1, 0);

insert into user_roles(roles_id, user_id) values
(3, 30), (3, 31), (3, 32), (3, 33);

INSERT INTO participants (user_id, conference_id, type_id) VALUES
(30, 1, 3), (31, 2, 3), (32, 3, 3), (33, 1, 3);
...
# Conf 1 Stream 1
('New in Spring', '2020-04-27', '14:00:00', '16:00:00', 'Why were we able to do this? If we inspect the tables closely in the previous case, we can see, that it contained two many-to-one relationships. In other words, there isn''t any many-to-many relationship in an RDBMS. We call the structures we create with join tables many-to-many relationships because that''s what we model.
Besides, it''s more clear if we talk about many-to-many relationships, because that''s our intention. Meanwhile, a join table is just an implementation detail; we don''t really care about it.', 0, 1, 40, '/picture/img/topic/2.jpg'),

('Java in 2020', '2020-04-27', '16:15:00', '18:15:00', 'Why were we able to do this? If we inspect the tables closely in the previous case, we can see, that it contained two many-to-one relationships. In other words, there isn''t any many-to-many relationship in an RDBMS. We call the structures we create with join tables many-to-many relationships because that''s what we model.
Besides, it''s more clear if we talk about many-to-many relationships, because that''s our intention. Meanwhile, a join table is just an implementation detail; we don''t really care about it.', 0, 1, 40, '/media/5-best-cover-templates-free-presentation-power-point-1-638.jpg'),

('New in Kotlin', '2020-04-27', '18:30:00', '20:15:00', 'Why were we able to do this? If we inspect the tables closely in the previous case, we can see, that it contained two many-to-one relationships. In other words, there isn''t any many-to-many relationship in an RDBMS. We call the structures we create with join tables many-to-many relationships because that''s what we model.
Besides, it''s more clear if we talk about many-to-many relationships, because that''s our intention. Meanwhile, a join table is just an implementation detail; we don''t really care about it.', 1, 1, 40, '/media/45eb586a713808c781ad61814151ab28.jpg'),

('React Framework', '2020-04-27', '20:25:00', '22:15:00', 'Why were we able to do this? If we inspect the tables closely in the previous case, we can see, that it contained two many-to-one relationships. In other words, there isn''t any many-to-many relationship in an RDBMS. We call the structures we create with join tables many-to-many relationships because that''s what we model.
Besides, it''s more clear if we talk about many-to-many relationships, because that''s our intention. Meanwhile, a join table is just an implementation detail; we don''t really care about it.', 1, 1, 40, '/media/c2525e9cf24019a77f065d695ffce3fd.jpg'),

('IT after Pandemic', '2020-04-27', '17:30:00', '19:30:00', 'Why were we able to do this? If we inspect the tables closely in the previous case, we can see, that it contained two many-to-one relationships. In other words, there isn''t any many-to-many relationship in an RDBMS. We call the structures we create with join tables many-to-many relationships because that''s what we model.
Besides, it''s more clear if we talk about many-to-many relationships, because that''s our intention. Meanwhile, a join table is just an implementation detail; we don''t really care about it.', 1, 4, 40, '/media/da130af95dc4055bc7dd9d77491aad36.png'),

('Angular Framework', '2020-04-28', '10:11:00', '12:15:00', 'Why were we able to do this? If we inspect the tables closely in the previous case, we can see, that it contained two many-to-one relationships. In other words, there isn''t any many-to-many relationship in an RDBMS. We call the structures we create with join tables many-to-many relationships because that''s what we model.
Besides, it''s more clear if we talk about many-to-many relationships, because that''s our intention. Meanwhile, a join table is just an implementation detail; we don''t really care about it.', 1, 4, 40, '/media/eebf5963e6bfab4a40d9ddf84dff9773.jpg'),

('Front-End development', '2020-04-28', '12:30:00', '14:40:00', 'Why were we able to do this? If we inspect the tables closely in the previous case, we can see, that it contained two many-to-one relationships. In other words, there isn''t any many-to-many relationship in an RDBMS. We call the structures we create with join tables many-to-many relationships because that''s what we model.
Besides, it''s more clear if we talk about many-to-many relationships, because that''s our intention. Meanwhile, a join table is just an implementation detail; we don''t really care about it.', 1, 4, 40, '/media/FF0021-01-cover-slides-11.jpg'),

('New in Deep Learning', '2020-04-28', '14:50:00', '16:40:00', 'Why were we able to do this? If we inspect the tables closely in the previous case, we can see, that it contained two many-to-one relationships. In other words, there isn''t any many-to-many relationship in an RDBMS. We call the structures we create with join tables many-to-many relationships because that''s what we model.
Besides, it''s more clear if we talk about many-to-many relationships, because that''s our intention. Meanwhile, a join table is just an implementation detail; we don''t really care about it.', 1, 4, 40, '/media/maxresdefault.jpg'),


# Conf 2 Stream 2
('New in Gradel', '2020-04-29', '12:00:00', '14:15:00', 'Let''s say we want to let students register to courses. Also, we need to store the point when a student registered for a specific course. On top of that, we also want to store what grade she received in the course.
...
('Problem and solutions in busines psychology', '2020-04-30', '14:00:00', '16:15:00', 'The implementation of a simple many-to-many relationship was rather straightforward. The only problem is that we cannot add a property to a relationship that way, because we connected the entities directly. Therefore, we had no way to add a property to the relationship itself.
...
# Conf 3 Stream 3
('Future of mobile internet', '2020-04-26', '17:00:00', '19:00:00', 'Again, we configured the relationship before. Hence, we only need to tell JPA, where can it find that configuration.
...
('5G in Europe', '2020-04-27', '16:00:00', '18:00:00', 'A relationship is a connection between two types of entities. In case of a many-to-many relationship, both sides can relate to multiple instances of the other side.
